...
import java.sql.*;
public class Delete_Profile extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 3), "DELETE PROFILE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24))); // NOI18N
        ...
        jLabel1.setText("Do you want to delete your profile ?");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try
        {
            String userAns="Yes",sql;
            if(jRadioButton1.isSelected())
                userAns="No";
            if(userAns.equals("No"))
            {
                sql="update profile_master set ISACTIVE='"+userAns+"' where username='"+username+"'";
